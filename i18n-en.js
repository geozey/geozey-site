/* ============================================================
   ...
   francais. Le retour au francais restaure le texte d'origine
   memorise sur chaque noeud lors du premier passage en anglais :
   il n'existe pas de dictionnaire inverse.
...
(function () {
  ...
  // Expose les deux fonctions au chargeur (i18n.js), qui les appelle
  // une fois ce fichier telecharge.
  window.gzAppliquerAnglais = appliquerAnglais;
  window.gzAppliquerFrancais = appliquerFrancais;
})();
