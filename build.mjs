...
const pages = ['index.html', 'manifeste.html', 'experts.html', 'interventions.html', 'styles.css', 'candidature.html', 'supabase-config.js', 'mentions-legales.html', 'politique-rgpd.html'];
